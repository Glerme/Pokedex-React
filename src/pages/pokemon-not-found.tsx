...
const PokemonNotFound: NextPage = () => {
        ...
        <div className="max-w-2xl w-full text-center space-y-8">
          <div className="relative w-64 h-64 mx-auto mb-8">
            <Image
              ...
              width={256}
              height={256}
              className="object-contain opacity-50 animate-bounce"
              priority
            />
          ...
          <div className="space-y-4">
            ...
            <h2 className="text-2xl font-medium text-white/90">
              {name ? `"${name}"` : "This Pokemon"} hasn't been discovered yet!
            </h2>
            <p className="text-lg text-white/70">
              Try searching for a different Pokemon in our Pokedex.
            </p>
          </div>
          ...
          <div className="pt-8">
            <button
              onClick={() => router.push("/")}
              className="px-8 py-3 bg-primary text-white rounded-xl font-medium hover:opacity-90 transition-opacity inline-flex items-center gap-2 group"
            >
              <svg
